...
if(isset($_GET['cancel']))
  {
    $query=mysqli_query($con,"update appointment set doctorStatus='0' where ID = '".$_GET['ID']."'");
    if($query)
    {
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  <?php 
                    ...
                    $query = "select pid,ID,fname,lname,gender,email,contact,appdate,apptime,userStatus,doctorStatus from appointment where doctor='$dname';";
